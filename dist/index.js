...
server.tool("scout_handoff", "Show a banner in the live browser asking the user to take a manual action (e.g. solve a CAPTCHA, complete MFA, handle a verification prompt). Blocks until the user clicks Done or the timeout elapses.", {
